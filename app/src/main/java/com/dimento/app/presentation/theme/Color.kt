...
val DarkOnPrimaryContainer = Color(0xFFEAFFE2) // Light text on dark green container
val DarkTertiaryContainer = Color(0xFF4A4B2B)  // Subtle yellow for FUTURE
val DarkOnTertiaryContainer = Color(0xFFE8E8B8)
val DarkTertiary = Color(0xFFE8E8B8)    // Light tertiary
val DarkSecondaryContainer = Color(0xFF3B5045)
val DarkOnSecondaryContainer = Color(0xFFE2E8E6)
